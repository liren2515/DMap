...
def main():
    ...
    for img_path in img_paths:
        ...
        for batch in dataloader:
            ...
            pred_keypoints_3d = out['pred_keypoints_3d'][:1]
            # Render the result
        ...
        if args.full_frame and len(all_verts) > 0:
            ...
            cam_view, P = renderer.render_rgba_multiple(all_verts, cam_t=all_cam_t, render_res=img_size[n], **misc_args)

            img_fn, _ = os.path.splitext(os.path.basename(img_path))
            data_save = {'output':out, 'pred_cam_t_full':pred_cam_t_full, 'P':P}
            torch.save(
